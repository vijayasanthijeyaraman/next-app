import { SideChatbot } from "EAMBlog/components/ChatBot";
      ...
      <div className="max-w-screen-lg mx-auto h-full px-6 py-4 text-justify">
        <div className="py-2 space-y-3">
          ...
          <p className="text-base md:text-lg">
            I&lsquo;m here to assist you with any questions you have. Whether
            you need help with product information, troubleshooting, or just
            want to have a chat, I&lsquo;m at your service.
          </p>
          <p className="text-base md:text-lg">
            Feel free to ask me anything, and I&lsquo;ll do my best to provide
            you with the information you need is an invitation or encouragement
            for users to engage with the chatbot by asking questions or seeking
            assistance.
          </p>
          <p className="text-base md:text-lg">
            Side chatbots are a versatile and effective tool for enhancing user
            engagement, providing customer support, and streamlining
            communication between businesses and their audience in a
            non-intrusive and user-friendly manner.
          </p>
          <p className="text-base md:text-lg">
            Website or application owners can customize the appearance,
            behavior, and functionality of side chatbots to align with their
            brand identity, user interface design, and specific requirements.
          </p>
        </div>
        <div className="py-2 space-y-3">
        ...
        <div className="py-2 space-y-3">
          ...
          <ul className="text-base md:text-lg space-y-4">
            ...
            <li>
              4.Once the chat interface expands, you can start typing your
              questions or messages.
            </li>
            <li>
              5.Expect instant responses from the AI chatbot to assist you
              further.
            </li>
          </ul>
        </div>
