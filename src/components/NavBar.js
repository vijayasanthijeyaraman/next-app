  ...
  return (
    <div className="px-6 py-4 w-full h-16 rounded-lg text-purple-500 bg-purple-100 shadow-md shadow-gray-300">
      <div className="max-w-screen-xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="text-lg flex items-center justify-end gap-x-1 sm:gap-x-3 text-purple-500 ">
          <button
          ...
          <div
            className={`w-40 md:w-full md:block ${
              isMobileMenuOpen
                ? "absolute top-14 right-6 rounded-lg divide divide-purple-400 border border-purple-400 bg-purple-50 "
                : "hidden"
            } `}
          >
            <ul className="flex flex-col font-medium rounded-lg md:flex-row md:space-x-6 divide-y divide-purple-400 md:divide-none">
              <li>
                <Link className="px-2" href="/" onClick={handleCloseMenu}>
                  Home
                </Link>
              </li>
              <li>
